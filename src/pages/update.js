        ...
        >
          <Form>
            <div className="inner">
              ...
              <Field type="text" id="Title" name="Title" placeholder="Title" value={jobInfo.Title} 
            ...
            <div className="inner">
              ...
              <Field type="text" id="Location" name="Location" placeholder="Location"  value={jobInfo.Location} 
              onChange={handleInputChange}/>
            </div>
            <div className="inner">
            ...
            <div className="inner">
              ...
              <Field type="date" id="PostedDate" name="PostedDate" value={jobInfo.PostedDate} onChange={handleInputChange}/>
            </div>
            <div className="inner">
              <label htmlFor="StartDate">Start Date:</label>
              <ErrorMessage name="StartDate" component="span" className="error-message" />
              <Field type="date" id="StartDate" name="StartDate" value={jobInfo.StartDate} onChange={handleInputChange}/>
            </div>
            <div className="inner">
              <label htmlFor="EndDate">End Date:</label>
              <ErrorMessage name="EndDate" component="span" className="error-message" />
              <Field type="date" id="EndDate" name="EndDate" value={jobInfo.EndDate} onChange={handleInputChange}/>
            </div>
            <div className="inner">
              <label htmlFor="SalaryRange">Salary Range:</label>
              <ErrorMessage name="SalaryRange" component="span" className="error-message" />
              <Field type="text" id="SalaryRange" name="SalaryRange" placeholder="Salary Range" value={jobInfo.SalaryRange} onChange={handleInputChange}/>
            </div>
            
            <div className="inner">
              <label htmlFor="CompanyID">Company ID:</label>
              <ErrorMessage name="CompanyID" component="span" className="error-message" />
              <Field type="number" id="CompanyID" name="CompanyID" placeholder="Company ID" value={jobInfo.CompanyID} />
            </div>
            <div className="inner">
